...
def dashboard():
    try:
        ...
        while len(caracteres_palabra)>0 and vidas>0:
            ...
            if letra_faltante in abecedario-caracteres_adivinados:
                ...
                if letra_faltante in caracteres_palabra:
                    ...
                    vidas-=1
                    print(Fore.GREEN+Style.BRIGHT+f"\n La letra {letra_faltante} no esta en la palabra."+Style.RESET_ALL)
                    print("\n")
        ...
        if vidas==0:
            print(Fore.BLUE+Style.BRIGHT+f" Perdiste!!!!!! , la palabra era: {palabra_escogida}"+Style.RESET_ALL)
        else:
            print(Fore.BLUE+Style.BRIGHT+f" Muy bien!!! , adivinaste la palabra ---> {palabra_escogida}"+Style.RESET_ALL)
