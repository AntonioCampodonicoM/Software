...
def menu():
    print(Fore.BLUE+Style.BRIGHT+"[1] Encriptar"+Style.RESET_ALL)
    print(Fore.BLUE+Style.BRIGHT+"[2] Desencriptar"+Style.RESET_ALL)
...
try:
    while opcion!=3:
        ...
        if opcion==1:
            ...
            print(Fore.RED+Style.BRIGHT+"[*] La encriptación es :"+Style.RESET_ALL)
            print("\n")
            print(">>> ",proceso_final)
            print("\n")
            ...
            palabra_codificada=input(Fore.RED+Style.BRIGHT+"[*] Ingrese la cadena encriptada : "+Style.RESET_ALL)
            print("\n")
            ...
            print(Fore.RED+Style.BRIGHT+"[*] La cadena desencriptada sería :"+Style.RESET_ALL)
            print("\n")
            print(">>> ",proceso_final)
            print("\n")
            print(Fore.GREEN+Style.BRIGHT+"[!] Elemento copiado en la clipboard"+Style.RESET_ALL)
